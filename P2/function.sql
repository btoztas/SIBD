...
RETURNS BOOL
BEGIN
	IF Bx1>Bx2 THEN Bx1=Bx2+Bx1; Bx2 = Bx1-Bx2; Bx1= Bx1 - Bx2; END IF
	IF Ax1>Ax2 THEN Ax1=Ax2+Ax1; Ax2 = Ax1-Ax2; Ax1= Ax1 - Ax2; END IF
	IF By1>By2 THEN By1=By2+By1; By2 = By1-By2; By1= By1 - By2; END IF
	IF Ay1>Ay2 THEN Ay1=Ay2+Ay1; Ay2 = Ay1-Bx2; Ay1= Ay1 - Ay2; END IF
